...
func (s *MySQLStorage) createProjectsTable() error {
	...
	createAt TIMESTAMP NOT NULL DEFAULT CURRENT TIMESTAMP,
	PRIMARY KEY (id)
...
func (s *MySQLStorage) createTasksTable() error {
	...
	CREATE TABLE IF NOT EXISTS tasks (
		...
		assignedToID INT UNISGNED NOT NULL,
		createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,

		PRIMARY KEY (id)
		FOREIGN KEY (assignedToID) REFERENCED users(id),
		FOREIGN KEY (projectId) REFERENCED projects(id)
		) ENGINE= InnoDB DEFAULT CHARSET=utf8;
	`)
